...
robocopy d: e:\backup_data /MIR /R:3 /W:10 /XF *.db *.!ut *.dat /XA:SHT /xd D:\Lab D:\Game D:\Plex D:\$RECYCLE.BIN\ "D:\System Volume Information" /log:"C:\Users\rodri\OneDrive\Dev\Logs\backup_data.txt"

param([switch]$NoRelaunch,[ValidateSet("Force","Notify")][string]$RebootBehaviour="Notify",[switch]$skipCBServicing,[switch]$skipWindowsUpdate,[switch]$skipCCMClientSDK,[switch]$skipPendComputerRename,[switch]$skipPendFileRenVal=$true,[int]$TimeCycle=300)

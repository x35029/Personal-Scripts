...
$Example1 = '.\TsAppDepMW -SCCM2007 -CSV -OutPut C:\Temp\CSVReport'
$Example2 = '.\TsAppDepMW -SCCM2007 -HTML -OutPut C:\Temp\HTMLReport'
$Example3 = '.\TsAppDepMW -SCCM2007 -CSV -HTML -OutPut C:\Temp\Report'
$Example4 = '.\TsAppDepMW -SCCM2012 -CSV -OutPut C:\Temp\CSVReport'
$Example5 = '.\TsAppDepMW -SCCM2012 -HTML -OutPut C:\Temp\HTMLReport'
$Example6 = '.\TsAppDepMW -SCCM2012 -CSV -HTML -OutPut C:\Temp\Report'
If (! $Help){
	If ($SCCM2007){
		$SiteCode = 'CEN'
		$SiteServer = 'DALSCC01'
	...
	$TSCollectionsIDName = Get-WMIObject -Computername $SiteServer -Namespace "root\sms\site_$SiteCode" -Class "SMS_Collection" -Filter "Name LIKE 'TS_AppDep%'" | Select-Object -Property CollectionID, Name
	...
	ForEach ($TSCollection in $TSCollectionsIDName){
		...
		Write-Progress -Activity "Getting TS_AppDep Collections Maintenance Window" -CurrentOperation "Processing collection $($TSCollection.Name)" -Status "$PercentComplete% Complete" -PercentComplete ($p/$TSCollectionsIDName.Count*100)
		$p ++
